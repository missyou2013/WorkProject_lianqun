            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case EVENT_CONNECT_SUCCESS:
                        int result = CustomApplication.getJni().getDeviceList(CustomApplication
                                .serverId);
                        ...
                        UserInfo userInfo = CustomApplication.getJni().getUserInfo
                        ...
                        /**
                         * TODO:�ж�ѡ��
                         * huamaiyun��see1000����Ҫ���userInfo.useTransferService !=8
                         *
                         * ����ж� seebao����Ҫȥ�����������ױ��?
                         */
